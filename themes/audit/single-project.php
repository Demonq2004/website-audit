...
<main class="project-main">
    <article class="project-container">
        ...
        <header class="project-header">
            <a href="<?php echo esc_url($archive_link ? $archive_link : home_url()); ?>" class="back-link">
            ...
            <div class="tech-grid">
                <div class="tech-col">
                    <div class="tech-col-header">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 5.33A2.67 2.67 0 0 0 15.33 3H8.67A2.67 2.67 0 0 0 6 5.33v13.34A2.67 2.67 0 0 0 8.67 21h6.66A2.67 2.67 0 0 0 18 18.67z"/><path d="M12 17h.01"/><path d="M8 8h8"/></svg>
                        <h3>Frontend</h3>
                    </div>
                    <ul class="tech-list">
                        <?php 
                        if($tech_frontend) {
                            $items = explode("\n", trim($tech_frontend));
                            foreach($items as $item) { if(trim($item)) echo '<li>' . esc_html(trim($item)) . '</li>'; }
                        }
                        ?>
                    </ul>
                </div>
        ...
        <div class="content-grid">
            ...
            <section aria-labelledby="the-solution">
                <div class="content-header icon-blue">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>
