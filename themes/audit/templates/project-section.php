...
<section class="featured-projects" aria-labelledby="projects-heading">
    <div class="featured-projects__container">
        <div class="featured-projects__header">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline><line x1="14" y1="4" x2="10" y2="20"></line></svg>
                    ...
                    <?php if($technologies && !is_wp_error($technologies)): ?>
                        <ul aria-label="Technologies used" class="project-card__tags">
                            <?php foreach($technologies as $tech): ?>
                                <li>
                                    <a href="<?php echo esc_url(get_term_link($tech)); ?>">
